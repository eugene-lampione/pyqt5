...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(664, 175)
        self.centralwidget = QtWidgets.QWidget(MainWindow)
        self.centralwidget.setObjectName("centralwidget")
        self.label = QtWidgets.QLabel(self.centralwidget)
        self.label.setGeometry(QtCore.QRect(50, 15, 531, 21))
        font = QtGui.QFont()
        font.setPointSize(16)
        self.label.setFont(font)
        self.label.setObjectName("label")
        self.comboBox = QtWidgets.QComboBox(self.centralwidget)
        self.comboBox.setGeometry(QtCore.QRect(50, 51, 420, 40))
        font = QtGui.QFont()
        font.setPointSize(16)
        self.comboBox.setFont(font)
        self.comboBox.setObjectName("comboBox")
        self.pushButton = QtWidgets.QPushButton(self.centralwidget, clicked=lambda:self.clicker())
        self.pushButton.setGeometry(QtCore.QRect(490, 50, 140, 40))
        font = QtGui.QFont()
        font.setPointSize(16)
        ...
        self.comboBox.addItem("Bacon")

        # add a list
        myToppings = ["Ham", "Pineapple","Supreme"]
        self.comboBox.addItems(myToppings)
