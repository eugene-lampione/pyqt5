...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(168, 267)
        self.centralwidget = QtWidgets.QWidget(MainWindow)
        self.centralwidget.setObjectName("centralwidget")
        self.red_checkBox = QtWidgets.QCheckBox(self.centralwidget)
        self.red_checkBox.setGeometry(QtCore.QRect(50, 20, 85, 20))
        font = QtGui.QFont()
        ...
        self.blue_checkBox.setGeometry(QtCore.QRect(50, 60, 85, 20))
        font = QtGui.QFont()
        font.setPointSize(16)
        ...
        self.pushButton.setGeometry(QtCore.QRect(50, 100, 81, 41))
        font = QtGui.QFont()
        font.setPointSize(16)
        self.pushButton.setFont(font)
        self.pushButton.setObjectName("pushButton")
        self.label = QtWidgets.QLabel(self.centralwidget)
        self.label.setGeometry(QtCore.QRect(50, 140, 111, 51))
        font = QtGui.QFont()
        font.setPointSize(16)
        ...
        self.menubar.setGeometry(QtCore.QRect(0, 0, 168, 30))
